...
class RestaurantsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'delivery_time' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'delivery_price' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'user_id' => 1,
                'created' => '2020-07-23 21:21:05',
                'updated' => '2020-07-23 21:21:05',
            ],
        ];
        parent::init();
    }
